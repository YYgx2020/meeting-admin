<template>
  <div class="job-page">
    ...
    <el-table id="selectTable" :data="staffJobData" border style="width: 100%">
...
<script>
import { getAllStaffJobRecord, getStaffJobInfoByKeyWord, updateStaffJobInfoByCode } from '@/api';
